        ...
        <div class="panel-body ">
            <table class="table w-auto Link-kanit mx-auto" >
                ...
                <tbody class="text-center">
                    <tr>
                        <td> ๑</td>
                        <td class="text-left" style="width: 300px;">กฎระเบียบคำสั่งสอน เล่ม ๑๑</td>
                        <td class="">
                    ...
                    <tr>
                        <td> ๒</td>
                        <td class="text-left" style="width: 300px;">กฎระเบียบคำสั่งสอน เล่ม ๑๒</td>
                    ...
                    <tr>
                        <td> ๓</td>
                        <td class="text-left" style="width: 300px;">กฎระเบียบคำสั่งสอน เล่ม ๑๓</td>
                    ...
                    <tr>
                        <td> ๔</td>
                        <td class="text-left" style="width: 300px;">กฎระเบียบคำสั่งสอน เล่ม ๑๔</td>
                        <td><a href="#audio-popup" data-src="audio/bensound-summer.mp3" class="open-popup-audio"><img src="images/icon_music32.gif" width="32" height="32" border="0" alt="ฟัง"></a></td>
                    </tr>
                    <tr>
                        <td> ๕</td>
                        <td class="text-left" style="width: 300px;">กฎระเบียบคำสั่งสอน เล่ม ๑๕</td>
                        <td><a href="#audio-popup" data-src="audio/bensound-ukulele.mp3" class="open-popup-audio"><img src="images/icon_music32.gif" width="32" height="32" border="0" alt="ฟัง"></a></td>
                    </tr>
